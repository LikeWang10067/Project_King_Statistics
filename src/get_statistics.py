...
if __name__ == "__main__":
    ...
    def usage():
        ...
        print('\tThe default setting is to get the statistics of repositories, not including the statistics of programming languages')
        print('\tThe default setting is not to print the log of cloc and save the repositories')
        print('\tIf you want to change the default settings, please use -o, -a, -c, and -l options')
        print('Example:')
        ...
        print('\t$ python get_statistics.py -t <GitHub token> -o langchain-ai -a commits,stars -c -l')
        print('\tMeaning: get statistics of commits and stars for all repositories in the organization: langchain-ai')
        print('\t\tand get the statistics of programming languages and print the log of cloc and save the repositories')
        sys.exit(0)
    try:
